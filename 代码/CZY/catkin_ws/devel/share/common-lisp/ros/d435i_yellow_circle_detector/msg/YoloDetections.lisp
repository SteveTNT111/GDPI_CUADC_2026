...
(cl:defclass <YoloDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector d435i_yellow_circle_detector-msg:YoloDetection)
   :initform (cl:make-array 0 :element-type 'd435i_yellow_circle_detector-msg:YoloDetection :initial-element (cl:make-instance 'd435i_yellow_circle_detector-msg:YoloDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <YoloDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'YoloDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name d435i_yellow_circle_detector-msg:<YoloDetections> is deprecated: use d435i_yellow_circle_detector-msg:YoloDetections instead.")))
...
(cl:defmethod detections-val ((m <YoloDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader d435i_yellow_circle_detector-msg:detections-val is deprecated.  Use d435i_yellow_circle_detector-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <YoloDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'd435i_yellow_circle_detector-msg:YoloDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<YoloDetections>)))
  ...
  "d435i_yellow_circle_detector/YoloDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'YoloDetections)))
  "Returns string type for a message object of type 'YoloDetections"
  "d435i_yellow_circle_detector/YoloDetections")
