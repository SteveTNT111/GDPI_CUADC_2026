...
class YellowCircleDetector:
    ...
    def color_callback(self, msg):
        ...
        if self.enable_record:
            self.record_frames(annotated, binary_mask)
    ...
    def init_recorders(self, annotated, binary_mask):
        ...
        if not self.annotated_writer.isOpened() or not self.binary_writer.isOpened():
    ...
    def record_frames(self, annotated, binary_mask):
        if not self.record_ready:
            self.init_recorders(annotated, binary_mask)
            if not self.record_ready:
                return
